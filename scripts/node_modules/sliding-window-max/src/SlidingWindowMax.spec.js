...
test.each([
  ...
  /** windowSize=6 **/
  {
    ...
    expectedResults: [null, null, null, null, null, 30, 30, 30, 40, 40, 40, 40, 40, 40, 30, 30]
  },
  ...
  /** waitFullRange=false **/
  {
    ...
    dataset: [0, 10, 20, 30, 20, 10, 20, 30, 40, 30, 20, 10, 20, 30, 20, 10],
    expectedResults: [0, 10, 20, 30, 30, 30, 20, 30, 40, 40, 40, 30, 20, 30, 30, 30]
  },
  ...
  /** custom comparator **/
  {
    ...
    dataset: [{ v: 0 }, { v: 10 }, { v: 20 }, { v: 30 }, { v: 20 }, { v: 100 }],
    expectedResults: [null, null, { v: 20 }, { v: 30 }, { v: 30 }, { v: 100 }]
  },
  ...
  /** custom comparator **/
  {
    ...
    dataset: [{ v: 0, n: 1 }, { v: 10, n: 2 }, { v: 20, n: 3 }, { v: 30, n: 4 }, { v: 20, n: 5 }],
    expectedResults: [{ v: 0, n: 1 }, { v: 10, n: 2 }, { v: 20, n: 3 }, { v: 30, n: 4 }, { v: 30, n: 4 }]
  }
])(' sliding window max with sample %#', ({ dataset, expectedResults, options, windowSize }) => {
  const slidingWindowMax = new SlidingWindowMax(windowSize, options)
...
test('sliding window max with big data', () => {
  ...
  const expectedResults = [
    ...(Array(windowSize - 1).fill(null)),
    ..._calculateExpectedResultUtils(windowSize, dataset)
  ]
...
test('test _calculateExpectedResultUtils', () => {
  expect(_calculateExpectedResultUtils(3, [1, 3, -1, -3, 5, 3, 6, 7]))
    .toEqual([3, 3, 5, 5, 6, 7])
})

function _calculateExpectedResultUtils (slidingWindow, dataset) {
  const res = []
